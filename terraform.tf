...
resource "aws_elastic_beanstalk_application" "dnl-dev-tracker" {
  name        = "dnl-dev-tracker"
}

resource "aws_elastic_beanstalk_environment" "dnl-dev-tracker" {
  name                = "dnl-dev-tracker"
  application         = "${aws_elastic_beanstalk_application.dnl-dev-tracker.name}"
...
resource "aws_iam_role" "beanstalk_instance_profile_role" {
  name = "beanstalk_instance_profile_role"
...
resource "aws_codepipeline" "dnl-dev-tracker-pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ApplicationName = "${aws_elastic_beanstalk_application.dnl-dev-tracker.name}"
        EnvironmentName = "${aws_elastic_beanstalk_environment.dnl-dev-tracker.name}"
      }
    }
  }
}
...
output "beanstalk_cname" {
  value = "${aws_elastic_beanstalk_environment.dnl-dev-tracker.cname}"
}
